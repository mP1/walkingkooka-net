 ...
 */
final class NetConverterTextToHostAddress<C extends ConverterContext> extends NetConverterTextTo<C> {

    /**
     * Type safe getter.
     */
    static <C extends ConverterContext> NetConverterTextToHostAddress<C> instance() {
