 ...
 */
final class NetConverterTextToEmailAddress<C extends ConverterContext> extends NetConverterTextTo<C> {

    /**
     * Type safe getter.
     */
    static <C extends ConverterContext> NetConverterTextToEmailAddress<C> instance() {
