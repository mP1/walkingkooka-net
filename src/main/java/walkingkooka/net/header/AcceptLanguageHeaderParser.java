 ...
 * </pre>
 */
final class AcceptLanguageHeaderParser extends AcceptLanguageOrAcceptLanguageValueHeaderParser {

    static AcceptLanguage parseAcceptLanguage(final String text) {
        final AcceptLanguageHeaderParser parser = new AcceptLanguageHeaderParser(text);
        parser.parse();
    ...
    private AcceptLanguageHeaderParser(final String text) {
        super(text);
    }
