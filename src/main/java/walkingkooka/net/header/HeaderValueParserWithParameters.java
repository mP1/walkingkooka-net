...
/**
 * A {@link HeaderValueParser} variant that supports a single value followed by optional parameters.
 */
abstract class HeaderValueParserWithParameters<V extends HeaderValueWithParameters<N>,
        N extends HeaderParameterName<?>>
        extends HeaderValueParser {
    /**
     * Package private to limit sub classing.
     */
    HeaderValueParserWithParameters(final String text) {
        super(text);
    }
