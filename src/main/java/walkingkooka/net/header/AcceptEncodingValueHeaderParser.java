 ...
 * </pre>
 */
final class AcceptEncodingValueHeaderParser extends HeaderParserWithParameters<AcceptEncodingValue, AcceptEncodingValueParameterName<?>> {

    static AcceptEncodingValue parseEncoding(final String text) {
        final AcceptEncodingValueHeaderParser parser = new AcceptEncodingValueHeaderParser(text);
        parser.parse();
        return parser.encoding;
    }

    private AcceptEncodingValueHeaderParser(final String text) {
        super(text);
    }
