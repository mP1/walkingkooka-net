...
/**
 * A {@link HeaderValueHandler} that parses a header value into a {@link &lt;Range&lt;Long&gt;&gt;}.
 ...
 * </pre>
 */
final class RangeHeaderValueHeaderValueHandler extends NonStringHeaderValueHandler<RangeHeaderValue> {

    /**
     * Singleton
     */
    final static RangeHeaderValueHeaderValueHandler INSTANCE = new RangeHeaderValueHeaderValueHandler();

    /**
     * Private ctor use singleton.
     */
    private RangeHeaderValueHeaderValueHandler() {
        super();
    }
    ...
    void check0(final Object value, final Name name) {
        this.checkType(value,
                v-> v instanceof RangeHeaderValue,
