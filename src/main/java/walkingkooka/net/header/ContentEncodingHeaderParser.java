 ...
 * </pre>
 */
final class ContentEncodingHeaderParser extends HeaderParser {

    static ContentEncoding parseContentEncoding(final String text) {
        final ContentEncodingHeaderParser parser = new ContentEncodingHeaderParser(text);
        parser.parse();
        return ContentEncoding.with(parser.encodings);
    }

    private ContentEncodingHeaderParser(final String text) {
        super(text);
    }
