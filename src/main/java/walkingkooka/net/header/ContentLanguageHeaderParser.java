 ...
 * </pre>
 */
final class ContentLanguageHeaderParser extends HeaderParser {

    static ContentLanguage parseContentLanguage(final String text) {
        final ContentLanguageHeaderParser parser = new ContentLanguageHeaderParser(text);
        parser.parse();
        return ContentLanguage.with(parser.languages);
    }

    private ContentLanguageHeaderParser(final String text) {
        super(text);
    }
