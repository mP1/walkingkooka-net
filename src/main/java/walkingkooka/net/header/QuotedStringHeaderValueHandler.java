...
/**
 * A {@link HeaderValueHandler} that handles string values in quotes with possible backslash escaping.
 */
final class QuotedStringHeaderValueHandler extends QuotedOrUnquotedStringHeaderValueHandler {

    /**
     * Factory that creates a new {@link QuotedStringHeaderValueHandler}.
     */
    static QuotedStringHeaderValueHandler with(final CharPredicate predicate,
                                               final boolean supportBackslashEscaping) {
        return new QuotedStringHeaderValueHandler(predicate, supportBackslashEscaping);
    }

    /**
     * Private ctor use singleton.
     */
    private QuotedStringHeaderValueHandler(final CharPredicate predicate,
                                           final boolean supportBackslashEscaping) {
        super(predicate);
