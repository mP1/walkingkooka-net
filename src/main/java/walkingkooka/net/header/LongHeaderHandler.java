 ...
 */
final class LongHeaderHandler extends NonStringHeaderHandler<Long> {

    /**
     * Singleton
     */
    final static LongHeaderHandler INSTANCE = new LongHeaderHandler();

    /**
     * Private ctor use singleton.
     */
    private LongHeaderHandler() {
        super();
    }
