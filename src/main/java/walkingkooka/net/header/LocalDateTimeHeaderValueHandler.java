...
/**
 * A {@link HeaderValueHandler} that parses a header value into a {@link LocalDateTime}.
 * Sample Date/Time
 * <pre>
 ...
 */
final class LocalDateTimeHeaderValueHandler extends NonStringHeaderValueHandler<LocalDateTime> {

    /**
     * Singleton
     */
    final static LocalDateTimeHeaderValueHandler INSTANCE = new LocalDateTimeHeaderValueHandler();

    /**
     * Private ctor use singleton.
     */
    private LocalDateTimeHeaderValueHandler() {
        super();
    }
