 ...
 * </pre>
 */
final class LinkRelationHeaderParser extends HeaderParser {
    ...
    static List<LinkRelation<?>> parseLinkRelationList(final String text) {
        final LinkRelationHeaderParser parser = new LinkRelationHeaderParser(text);
        parser.parse();
        return parser.relations;
    }

    private LinkRelationHeaderParser(final String text) {
        super(text);
    }
