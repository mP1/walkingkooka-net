 ...
 * </pre>
 */
final class MediaTypeBoundaryHeaderValueHandler extends NonStringHeaderValueHandler<MediaTypeBoundary> {

    /**
     * Singleton
     */
    final static MediaTypeBoundaryHeaderValueHandler INSTANCE = new MediaTypeBoundaryHeaderValueHandler();

    /**
     * Private ctor use singleton.
     */
    private MediaTypeBoundaryHeaderValueHandler() {
        super();
    }
    ...
    private final HeaderValueHandler<String> STRING_PARSER = HeaderValueHandler.quotedUnquotedString(MediaTypeBoundary.QUOTED_CHARACTER_PREDICATE,
            false,
