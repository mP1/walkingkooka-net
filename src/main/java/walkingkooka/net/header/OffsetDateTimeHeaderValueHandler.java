...
/**
 * A {@link HeaderValueHandler} that parses a header value into a {@link OffsetDateTime}.
 * Sample Date/Time
 * <pre>
 ...
 */
final class OffsetDateTimeHeaderValueHandler extends NonStringHeaderValueHandler<OffsetDateTime> {

    /**
     * Singleton
     */
    final static OffsetDateTimeHeaderValueHandler INSTANCE = new OffsetDateTimeHeaderValueHandler();

    /**
     * Private ctor use singleton.
     */
    private OffsetDateTimeHeaderValueHandler() {
        super();
    }
    ...
    private final static HeaderValueHandler<String> QUOTED_STRING = HeaderValueHandler.quoted(
