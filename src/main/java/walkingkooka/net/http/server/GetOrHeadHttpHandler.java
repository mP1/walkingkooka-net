...
/**
 * A {@link HttpHandler} that only allows {@link HttpMethod#GET} and {@link HttpMethod#HEAD} methods, returning
 * {@link walkingkooka.net.http.HttpStatusCode#METHOD_NOT_ALLOWED} for all other {@link HttpMethod}
 */
public interface GetOrHeadHttpHandler<C extends HttpHandlerContext> extends HttpHandler<C> {
