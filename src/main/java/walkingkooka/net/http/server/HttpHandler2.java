...
/**
 * A {@link HttpHandler} that examines the {@link HttpMethod} and dispatches to the matching
 * method.
 */
public interface HttpHandler2<C extends HttpHandlerContext> extends HttpHandler<C> {
