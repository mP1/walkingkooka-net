...
public final class NetConverterTextToHostAddressTest extends NetConverterTestCase<NetConverterTextToHostAddress<FakeConverterContext>, FakeConverterContext> {
    ...
    public void testConvertCharSequenceToHostAddress() {
        final String hostAddress = "example.com";

        this.convertAndCheck(
            new StringBuilder(hostAddress),
            HostAddress.with(hostAddress)
        );
    }

    @Test
    public void testConvertStringToHostAddress() {
        final String hostAddress = "example.com";
    ...
    @Override
    public NetConverterTextToHostAddress<FakeConverterContext> createConverter() {
