...
public final class NetConverterTextToUrlQueryStringTest extends NetConverterTextToTestCase<NetConverterTextToUrlQueryString<FakeConverterContext>, FakeConverterContext> {
    ...
    @Test
    public void testConvertStringToUrlQueryString() {
        final UrlQueryString queryString = UrlQueryString.parse("key1=value1&key2=value2");
    ...
    @Override
    public NetConverterTextToUrlQueryString<FakeConverterContext> createConverter() {
