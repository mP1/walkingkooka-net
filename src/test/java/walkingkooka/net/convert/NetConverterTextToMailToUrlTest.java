...
public final class NetConverterTextToMailToUrlTest extends NetConverterTestCase<NetConverterTextToMailToUrl<FakeConverterContext>, FakeConverterContext> {
    ...
    @Test
    public void testConvertStringToMailToUrl() {
        this.convertAndCheck2("mailto:user@example.com");
    }

    @Test
    public void testConvertStringBuilderToMailToUrl() {
        this.convertAndCheck2(
            new StringBuilder("mailto://user@example.com")
        );
    }

    private <T extends EmailAddress> void convertAndCheck2(final CharSequence mailTo) {
        this.convertAndCheck(
            mailTo,
            MailToUrl.class,
            MailToUrl.parseMailTo(mailTo.toString())
        );
    }

    @Override
    public NetConverterTextToMailToUrl<FakeConverterContext> createConverter() {
    ...
    @Override
    public Class<NetConverterTextToMailToUrl<FakeConverterContext>> type() {
        return Cast.to(NetConverterTextToMailToUrl.class);
    }
}
