...
public final class HttpEntityBinaryTest extends HttpEntityNotEmptyTestCase<HttpEntityBinary> {
    ...
    public void testToStringText() {
        ...
        this.toStringAndCheck(this.createHttpEntity(headers, "AB\nC"),
    ...
    private HttpEntityBinary createHttpEntity(final Map<HttpHeaderName<?>, Object> headers,
                                              final String text) {
    ...
    @Override
    HttpEntityBinary createHttpEntity(final Map<HttpHeaderName<?>, Object> headers) {
