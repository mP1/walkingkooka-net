...
public final class ETagOneHeaderValueParserTest extends ETagHeaderValueParserTestCase<ETagOneHeaderValueParser> {
    ...
    @Override
    public Class<ETagOneHeaderValueParser> type() {
        return ETagOneHeaderValueParser.class;
    }
}
