...
public final class LinkHeaderValueParserTest extends HeaderValueParserTestCase<LinkHeaderValueParser, List<Link>> {
    ...
    @Override
    public Class<LinkHeaderValueParser> type() {
        return LinkHeaderValueParser.class;
    }
}
