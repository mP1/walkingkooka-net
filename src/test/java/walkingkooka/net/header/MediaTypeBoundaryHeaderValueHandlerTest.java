...
public final class MediaTypeBoundaryHeaderValueHandlerTest extends
        NonStringHeaderValueHandlerTestCase<MediaTypeBoundaryHeaderValueHandler, MediaTypeBoundary> {
    ...
    @Override
    MediaTypeBoundaryHeaderValueHandler handler() {
        return MediaTypeBoundaryHeaderValueHandler.INSTANCE;
    }
    ...
    @Override
    public Class<MediaTypeBoundaryHeaderValueHandler> type() {
        return MediaTypeBoundaryHeaderValueHandler.class;
    }
}
