...
public final class AcceptEncodingValueHeaderParserTest extends HeaderParserTestCase<AcceptEncodingValueHeaderParser, AcceptEncodingValue> {
    ...
    @Override
    public Class<AcceptEncodingValueHeaderParser> type() {
        return AcceptEncodingValueHeaderParser.class;
    }
}
