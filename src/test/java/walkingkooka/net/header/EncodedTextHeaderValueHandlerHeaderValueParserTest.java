...
public final class EncodedTextHeaderValueHandlerHeaderValueParserTest extends HeaderValueParserTestCase<EncodedTextHeaderValueHandlerHeaderValueParser,
        EncodedText> {
    ...
    @Override
    public Class<EncodedTextHeaderValueHandlerHeaderValueParser> type() {
        return EncodedTextHeaderValueHandlerHeaderValueParser.class;
    }
}
