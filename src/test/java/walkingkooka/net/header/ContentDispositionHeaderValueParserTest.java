...
public final class ContentDispositionHeaderValueParserTest extends HeaderValueParserWithParametersTestCase<ContentDispositionHeaderValueParser,
        ContentDisposition> {
    ...
    @Override
    String valueLabel() {
        return ContentDispositionHeaderValueParser.TYPE;
    }

    @Override
    public Class<ContentDispositionHeaderValueParser> type() {
        return ContentDispositionHeaderValueParser.class;
    }
}
