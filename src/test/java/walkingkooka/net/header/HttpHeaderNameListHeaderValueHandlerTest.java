...
public final class HttpHeaderNameListHeaderValueHandlerTest extends
        NonStringHeaderValueHandlerTestCase<HttpHeaderNameListHeaderValueHandler, List<HttpHeaderName<?>>> {
    ...
    @Override
    HttpHeaderNameListHeaderValueHandler handler() {
    ...
    @Override
    public Class<HttpHeaderNameListHeaderValueHandler> type() {
        return HttpHeaderNameListHeaderValueHandler.class;
    }
}
