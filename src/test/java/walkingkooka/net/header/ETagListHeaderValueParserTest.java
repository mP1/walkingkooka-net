...
public final class ETagListHeaderValueParserTest extends ETagHeaderValueParserTestCase<ETagListHeaderValueParser> {
    ...
    @Override
    public Class<ETagListHeaderValueParser> type() {
        return ETagListHeaderValueParser.class;
    }
}
