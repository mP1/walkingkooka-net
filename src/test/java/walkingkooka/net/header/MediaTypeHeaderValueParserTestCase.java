...
public abstract class MediaTypeHeaderValueParserTestCase<P extends MediaTypeHeaderValueParser, V> extends HeaderValueParserWithParametersTestCase<P,
        V> {

    MediaTypeHeaderValueParserTestCase() {
        super();
    }
    ...
    final String valueLabel() {
        return MediaTypeHeaderValueParser.MEDIATYPE;
    }
}
