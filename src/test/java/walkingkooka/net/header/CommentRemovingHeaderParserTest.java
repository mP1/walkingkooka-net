...
public final class CommentRemovingHeaderParserTest extends HeaderParserTestCase<CommentRemovingHeaderParser, String> {
    ...
    @Override
    public Class<CommentRemovingHeaderParser> type() {
        return CommentRemovingHeaderParser.class;
    }
}
