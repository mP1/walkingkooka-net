...
public final class UnalteredStringHeaderValueHandlerTest extends StringHeaderValueHandlerTestCase<UnalteredStringHeaderValueHandler> {
    ...
    @Override
    protected UnalteredStringHeaderValueHandler handler() {
    ...
    @Override
    public Class<UnalteredStringHeaderValueHandler> type() {
        return UnalteredStringHeaderValueHandler.class;
    }
}
